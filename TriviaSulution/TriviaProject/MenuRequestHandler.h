...
class MenuRequestHandler : public IRequestHandler
{
	...
	RequestResult joinRoomsignout(RequestInfo info);
	RequestResult createRoom(RequestInfo info);
public:
	MenuRequestHandler(RoomManager& room_manager, StatisticsManager& statistics_manager, RequestHandlerFactory& handler_factory) : m_room_manager(room_manager),
